; ****************************************************************************
; sh386.s (sh6.s) - Retro Unix 386 v1 Shell - /bin/sh
; ----------------------------------------------------------------------------
;
...
; ((nasm sh6.s -l sh6.txt -o sh6 -Z error.txt))
...
; 17/06/2022 - Retro UNIX 386 v1.1
struc stat
...
;/ sh -- command interpreter
	...
	; 17/06/2022
	; 29/05/2022 - Erdogan Tan
	; (Modified by using disassembled unix v2 'sh' code.)
...
nch6: ;2:
	...
	jne	short nch_8  ; jne newcom
	jmp	newline  ; je newline
docom:
	sub	edi, parp
...
np11:
	...
	test	byte [stbuf+stat.mode+1], 40h ; directory ?
...
stbuf:	; 17/06/2022 - Retro UNIX 386 v1.1
	resb 34	; sysstat output buffer
