...
; Assembler: NASM 2.11
; 	nasm ls0.s, -l ls0.txt, -o ls0 -Z error.txt
; -----
;   --- unixcopy.com utility & fd0.img (1.44MB diskette) image file ---
;	(c:\runix386\> unixcopy fd0.img)
;	((FD0.IMG!/> fromdos ls0 /bin/ls))
;	((FD0.IMG!/> ?)) -for unixcopy commands help-  	
...
C2: ;1:
	...
	stosd
		; mov r2,(r1)+
	add	ebx, 20	; EBX now points to next 20 bytes
		; add $20.,r2
...
calcb:
	...
	;
	; eax = file (directory) size ; 22/01/2022
	add	eax, 511
