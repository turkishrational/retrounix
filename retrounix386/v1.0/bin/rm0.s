; ****************************************************************************
; rm386.s (rm0.s) - by Erdogan Tan - 25/04/2022
; ----------------------------------------------------------------------------
; Retro UNIX 386 v1 - remove -- remove (unlink/delete) file(s)
;
...
; ((nasm rm0.s -l rm0.txt -o rm0 -Z error.txt))
;
...
_return:
	; 27/04/2022
	mov	esp, ebp ; add esp, 80 (add esp, 100)
	pop	ebp 
...
program_msg:
	db 0Dh, 0Ah
	db "Retro UNIX 386 v1 RM by Erdogan TAN - 28/04/2022"
	db 0Dh, 0Ah, 0
usage_msg:
	db 0Dh, 0Ah
