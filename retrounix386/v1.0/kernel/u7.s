; Retro UNIX 386 v1 Kernel (v0.2.0.20) - SYS7.INC
...
sysmount: ; / mount file system; args special; name
	; 14/05/2022 (Retro UNIX 386 v1.0, Kernel v0.2.0.19)
	; 12/02/2022
	; 04/02/2022
	; 14/11/2015
	; 24/10/2015
	...
	; The device number of the special file is obtained vihha
...
sysmnt_5:
	...
	; invalid valid file system (invalid super block).
	; 
	...
	;;shl 	ecx, 3 ; !!!
	; 04/02/2022
	shr 	ecx, 3 ; (8 sectors per 1 fbm byte)
	...
	; ! Buffer header is 8 bytes (Retro UNIX 386 v1 and v1.1) !
...
sysumount: ; / special dismount file system,
	; 15/05/2022
	; 09/05/2022 (Retro UNIX 386 v1.0, Kernel v0.2.0.19)
	; 04/02/2022
	; 16/05/2015 (Retro UNIX 386 v1 - Beginning)
	; 09/07/2013 - 04/11/2013 (Retro UNIX 8086 v1)
	;
...
iopen:
	; 13/06/2022 - Retro UNIX 386 v1 (Kernel v0.2.0.20)
...
ejec:
	; 13/06/2022 - Retro UNIX 386 v1 (Kewrnel v0.2.0.20)
	;	     - Printer Initialization
lpt_init:	
