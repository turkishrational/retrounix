; Retro UNIX 386 v1 Kernel (v0.2.0.22) - SYS6.INC
...
readi:
	...
	;    (Retro UNIX Prototype : 01/03/2013 - 14/12/2012, UNIXCOPY.ASM)
        ;    ((Modified registers: EDX, EBX, ECX, ESI, EDI)) -14/07/2022- 
...
passc_0:
	...
	; EBX = linear address
	push 	ecx
	push	ebx ; * ; 03/02/2022 (BugFix)
	call 	copy_page
	pop	ebx ; * ; 03/02/2022 (BugFix)
	pop	ecx
	jc	short passc_2
	; 03/02/2022
...
; 13/06/2022 - Retro UNIX 386 v1 - PRINTER BIOS (Functions)
