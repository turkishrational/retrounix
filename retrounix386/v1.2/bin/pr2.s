; ****************************************************************************
; pr2.s (pr386.s) - print file - by Erdogan Tan - 25/06/2022
; ----------------------------------------------------------------------------
; Retro UNIX 386 v1.2 - file print utility 
;
; [ Last Modification: 26/06/2022 ]
...
; ((nasm pr2.s -l pr2.txt -o pr2 -Z error.txt))
...
START_CODE:
	; 26/06/2022 (pr2.s - Retro UNIX 386 v1.2)
	; 25/06/2022 (pr1.s - Retro UNIX 386 v1 & v1.1)
...
program_msg:
	db  0Dh, 0Ah
	db  'Retro UNIX 386 v1.2 PRINT Utility by Erdogan TAN - 26/06/2022'
	db  0Dh, 0Ah, 0
usage_msg:
	db  0Dh, 0Ah
