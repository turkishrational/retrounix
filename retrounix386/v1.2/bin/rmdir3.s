; ****************************************************************************
; rmdir386.s (rmdir3.s) - by Erdogan Tan - 11/03/2022
; ----------------------------------------------------------------------------
; Retro UNIX 386 v1.2 - rmdir -- unlink directory
;
; [ Last Modification: 12/03/2022 ]
;
...
; ((nasm rmdir3.s -l rmdir3.txt -o rmdir3 -Z error.txt))

; rmdir1.s - 12/03/2022 - Retro UNIX 386 v1.0 (unix v1 inode, 8 byte names)
; rmdir2.s - 12/03/2022 - Retro UNIX 386 v1.1 (unix v1 inode, 14 byte names)
; rmdir3.s - 12/03/2022 - Retro UNIX 386 v1.2 (& v2) (modified unix v7 inode)
...
test_msg:
	db  0Dh, 0Ah
	db  'Retro UNIX 386 v2 RMDIR by Erdogan TAN - 12/03/2022'
nl:
	db  0Dh, 0Ah, 0
mes1:
