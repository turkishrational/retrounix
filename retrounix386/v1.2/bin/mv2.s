; ****************************************************************************
; mv386.s (mv2.s) - by Erdogan Tan - 22/05/2022
; ----------------------------------------------------------------------------
; Retro UNIX 386 v1.2 - mv -- move (or rename) file (or directory)
;
...
; ((nasm mv2.s -l mv2.txt -o mv2 -Z error.txt))
...
mv_41:
	...
	; 27/05/2022 (Retro UNIX 386 v1.2)
	mov	eax, [st1dev]
	cmp	eax, [st2dev]
	je	short mv_42
...
program_msg:
	db  0Dh, 0Ah
	db  'Retro UNIX 386 v1.2 MOVE by Erdogan TAN - 27/05/2022'
	db  0Dh, 0Ah, 0
