; ****************************************************************************
; rm386.s (rm1.s) - by Erdogan Tan - 25/04/2022
; ----------------------------------------------------------------------------
; Retro UNIX 386 v1.1 - remove -- remove (unlink/delete) file(s)
;
...
; ((nasm rm1.s -l rm1.txt -o rm1 -Z error.txt))
;
...
program_msg:
	db 0Dh, 0Ah
	db "Retro UNIX 386 v1.1 RM by Erdogan TAN - 28/04/2022"
	db 0Dh, 0Ah, 0
usage_msg:
	db 0Dh, 0Ah
