UNIXCOPY.COM: (for Retro UNIX 386 v1.1)
...
NOTE:
Retro UNIX v1.1 bootable floppy disk images or (1.44MB) bootable disk (fs)
      can be created by using
      UNIXFDFS.COM utility (MSDOS program)
      then..
      UNIXCOPY.COM is used to copy files 
		from dos/windows to retro unix v1.1 fd (fs) disk
