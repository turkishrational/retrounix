; Retro UNIX 386 v1 Kernel (v0.2.1.6) - SYSX.INC (ux.s)
...
process:
	; 26/02/2022
	; 12/01/2022 (Retro UNIX 386 v1.1) 
	; 06/05/2015
...
;	 resb 1 ; 09/06/2015
mnti:	 resw 1
mntp:	 resw 1 ; 15/05/2022 ; (parent dir inumber of [mnti])
mpid:	 resw 1
rootdir: resw 1
; 14/02/2014
...
user:
	...
	u.ilgins: resw 1
	;u.cdrv:  resw 1 ; cdev
	u.cdrv:   resb 1 ; 09/01/2022
		  resb 1 ; 09/01/2022 (dword alignment)
	u.uid:	  resb 1 ; uid
	u.ruid:	  resb 1
	u.bsys:	  resb 1
	u.uno:	  resb 1
...
argc:	resb 1	; 12/01/2022 - Retro UNIX 386 v1.1 (Kernel v0.2.1.2)
	resb 1 
...
eofitab equ $ - systm ; 11/02/2022 (end of inode table)
	s.time:	 resd 1
	s.syst:	 resd 1
        s.wait_: resd 1 ; wait
	s.idlet: resd 1
